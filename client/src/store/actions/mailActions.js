...
import { mailTypes } from "../actionTypes";
...
export function sendMail(mail) {
  ...
  function request() {
    return { type: mailTypes.SEND_REQUEST };
  }
  function success(payload) {
    return { type: mailTypes.SEND_SUCCESS, payload };
  }
  function failed(payload) {
    return { type: mailTypes.SEND_FAILURE, payload };
  }
}
